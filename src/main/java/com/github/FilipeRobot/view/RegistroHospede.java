...
public class RegistroHospede extends JFrame {
     ...
     * Create the frame.
     */
    public RegistroHospede(Long codigoReserva) {
        ...
        txtDataN.getCalendarButton().setIcon(new ImageIcon(Objects.requireNonNull(RegistroHospede.class.getResource("/img/icon-reservas.png"))));
        ...
        txtNreserva.setText(codigoReserva.toString());
        ...
        imageFundo.setIcon(new ImageIcon(Objects.requireNonNull(RegistroHospede.class.getResource("/img/registro.png"))));
