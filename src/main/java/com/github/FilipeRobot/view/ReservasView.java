...
public class ReservasView extends JFrame {
    ...
    public ReservasView() {
        ...
        txtDataE.getCalendarButton().setIcon(new ImageIcon(Objects.requireNonNull(ReservasView.class.getResource("/img/icon-reservas.png"))));
...
//        txtDataE.setDateFormatString("yyyy-MM-dd");
        ...
        txtDataS.getCalendarButton().setIcon(new ImageIcon(Objects.requireNonNull(ReservasView.class.getResource("/img/icon-reservas.png"))));
...
//        txtDataS.setDateFormatString("yyyy-MM-dd");
        ...
        panel_1.add(logo);
        logo.setIcon(new ImageIcon(Objects.requireNonNull(ReservasView.class.getResource("/img/Ha-100px.png"))));

        JLabel imagenFondo = new JLabel("");
        imagenFondo.setBounds(0, 140, 500, 409);
        panel_1.add(imagenFondo);
        imagenFondo.setBackground(Color.WHITE);
        imagenFondo.setIcon(new ImageIcon(Objects.requireNonNull(ReservasView.class.getResource("/img/reservas-img-3.png"))));
